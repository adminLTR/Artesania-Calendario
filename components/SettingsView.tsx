  ...
  return (
    <div className="bg-white rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 shadow-sm h-full flex flex-col overflow-y-auto custom-scrollbar">
      <header className="mb-12">
        <h2 className="text-[30px] md:text-[38px] font-manrope font-extrabold text-gray-800 uppercase tracking-tight leading-none">Configuración del <span className="text-[#E55B69]">Sistema</span></h2>
        <p className="text-[13px] font-black text-gray-400 uppercase tracking-widest mt-3">Gestiona tus datos y conexiones</p>
      </header>
